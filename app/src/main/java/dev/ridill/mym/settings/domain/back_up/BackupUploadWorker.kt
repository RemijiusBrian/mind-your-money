...
@HiltWorker
class BackupUploadWorker @AssistedInject constructor(
    ...
    private suspend fun startForegroundService() {
        setForeground(
            ForegroundInfo(
                Random.nextInt(),
                notificationManager.buildForegroundNotification(R.string.notif_backup_in_progress)
            )
        )
    }
}
